...
export class PaymentComponent {
    ...
    updateShipping(user:ShopingCart): Observable<any> {
      const headers = { 'content-type': 'application/json'}  
      const body=JSON.stringify(user);
      console.log(body)
      return this.http.post(this.baseUrl + 'shoppingcart/closecart', body,{'headers':headers});
    }
    ...
    saveShipping(){
      ...
      this.updateShipping(this.payment)
      .subscribe(data => {
        console.log(data);
        window.location.href='/shop';
      }); 
